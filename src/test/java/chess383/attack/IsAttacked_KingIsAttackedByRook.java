/*
 *  IsAttacked_KingIsAttackedByRook.java
 *
...
/**
 * <p>
 * The class IsAttacked_KingIsAttackedByRook implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   June 2020
...
public class IsAttacked_KingIsAttackedByRook {  
    ...
    private Attack define() {
        ...
        Player secondPlayer = Player.create( ColorEnum.BLACK, Arrays.asList( 
                InitialKing.create( "e8" ), Rook.create( "e7" ) ));
        
        return Attack.create( firstPlayer, secondPlayer );
    }
    
    @Test
    @DisplayName("isAttacked(): return true for the white king because the black rook 'could' capture the white king.")
    public void isAttackedForKingLocationReturnsTrue_IfBlackRookCanCaptureTheKingLocation() {
