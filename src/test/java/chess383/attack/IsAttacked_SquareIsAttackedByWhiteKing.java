/*
 *  IsAttacked_SquareIsAttackedByWhiteKing.java
 *
...
/**
 * <p>
 * The class IsAttacked_SquareIsAttackedByWhiteKing implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   June 2020
...
public class IsAttacked_SquareIsAttackedByWhiteKing {  
    
    static private Attack define() {
        
        Player whitePlayer = Player.create( ColorEnum.WHITE, Arrays.asList( InitialKing.create( "e1" ), Rook.create( "h1" ), Knight.create( "g1" ) ) );
    ...
    @ParameterizedTest( name = "given two player lists and a location {0} it is checked whether a white king can attack this location." )
