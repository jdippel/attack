/*
 *  IsAttacked_SquareIsAttackedByBlackKnight.java
 *
...
/**
 * <p>
 * The class IsAttacked_SquareIsAttackedByBlackKnight implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   June 2020
...
public class IsAttacked_SquareIsAttackedByBlackKnight {  
    ...
    static private Attack define() {
        ...
        Player blackPlayer = Player.create( ColorEnum.BLACK, Arrays.asList( InitialKing.create( "e8" ), Knight.create( "d5" ), InitialBlackPawn.create( "c7" ) ));
        return Attack.create( whitePlayer, blackPlayer );
    }
    
    static private Attack attack = define();
    
    @ParameterizedTest( name = "given two player lists and a location {0} it is checked whether a black knight can attack this location." )
