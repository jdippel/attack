/*
 *  IsAttacked_SquareIsAttackedByBlackQueen.java
 *
...
/**
 * <p>
 * The class IsAttacked_SquareIsAttackedByBlackQueen implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   June 2020
...
public class IsAttacked_SquareIsAttackedByBlackQueen {  
    ...
    static private Attack define() {
        ...
        Player blackPlayer = Player.create( ColorEnum.BLACK, Arrays.asList( InitialKing.create( "e8" ), Queen.create( "c5" ), InitialBlackPawn.create( "c7" ) ));
        return Attack.create( whitePlayer, blackPlayer );
    }
    
    static private Attack attack = define();
    
    @ParameterizedTest( name = "given two player lists and a location {0} it is checked whether a black queen can attack this location." )
    ...
    public static Stream<Arguments> locationAndResultProvider() {
        return Stream.of(
          ...
          , Arguments.of( "a7", true )
          , Arguments.of( "d6", true )
          , Arguments.of( "e7", true )
